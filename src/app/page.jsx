...
Access expert insights, technical breakdowns, and real-time market opportunities — all in one platform designed to refine your trading strategy and maximize growth.</p>
      ...
      <div className="mt-7 grid gap-3 w-full sm:inline-flex">
        <a className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg bg-primary border border-primary-line text-primary-foreground hover:bg-primary-hover focus:outline-hidden focus:bg-primary-focus disabled:opacity-50 disabled:pointer-events-none" href="/signup">
          Get started
          <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6"/></svg>
        </a>
        <a className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg bg-layer border border-layer-line text-layer-foreground shadow-2xs hover:bg-layer-hover focus:outline-hidden focus:bg-layer-focus disabled:opacity-50 disabled:pointer-events-none" href="/Contact">
          Contact us
        </a>
      </div>
      {/* End Buttons */}
      ...
      <div className="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
        ...
        <div className="py-5">
          <div className="flex gap-x-1">
            <svg className="size-4 text-foreground" width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="mt-5">
            {/* Star */}
            <svg className="h-auto w-16 text-foreground" width="80" height="27" viewBox="0 0 80 27" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="py-5">
          ...
          <div className="mt-5">
            {/* Star */}
            <svg className="h-auto w-16 text-foreground" width="110" height="28" viewBox="0 0 110 28" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="relative ms-4">
      <img className="w-full rounded-md" src="heroimage.jpg" alt="Hero Image" />
      <div className="absolute inset-0 -z-1 bg-linear-to-tr from-surface-1 via-transparent to-travia-transparent size-full rounded-md mt-4 -mb-4 me-4 -ms-4 lg:mt-6 lg:-mb-6 lg:me-6 lg:-ms-6"></div>
  ...
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div className="grid gap-8 sm:grid-cols-2 sm:gap-y-10 xl:grid-cols-3">
      ...
      <div className="relative rounded-lg bg-gray-100 p-5 pt-8">
        ...
        <h3 className="mb-3 text-lg font-semibold text-indigo-500 md:text-xl">
         Does BharatInvesto provide real-time market updates?
        </h3>
        <p className="text-gray-500">
          Yes, we provide real-time market data, trend analysis, and instant alerts so you never miss important market movements.
        </p>
      </div>
      {/* question - end */}
      {/* question - start */}
      ...
      <div className="relative rounded-lg bg-gray-100 p-5 pt-8">
        ...
        <h3 className="mb-3 text-lg font-semibold text-indigo-500 md:text-xl">
         Is my data secure on BharatInvesto?
        </h3>
        <p className="text-gray-500">
          Absolutely. We prioritize security and transparency. Your data is protected using modern encryption and secure systems to ensure safe investing.
        </p>
      </div>
      {/* question - end */}
    </div>
